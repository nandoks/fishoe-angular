...
export const species: Species[] = [
    {
        ...
        family: 'Acanthuridae',
        genus: 'Acanthurus',
        distributionNotes: 'Western Atlantic: Bermuda, Florida, Gulf of Mexico, Caribbean Sea, south to Brazil.',
        description: 'Body oval and strongly compressed. Adults are olive-brown with numerous wavy blue lines on the head and body.',
    ...
    },
    {
        ...
        genus: 'Holacanthus',
        distributionNotes: 'Western Atlantic: Florida to Brazil, including Gulf of Mexico and Caribbean Sea.',
        description: 'Brightly colored with a blue body, yellow tail, and a distinctive crown-like spot on the forehead.',
        status: Status.PUBLISHED,
    ...
    },
    {
        ...
        description: 'Greenish-brown with a distinctive yellow spot on the upper tail base. Males have a bright green head.',
        status: Status.DRAFT,
    ...
    },
    {
        ...
        description: 'Small pufferfish with a pointed snout. Brownish body with blue spots and lines.',
        status: Status.PUBLISHED,
    ...
    },
    {
        ...
        family: 'Serranidae',
        genus: 'Epinephelus',
        distributionNotes: 'Western Atlantic: Bermuda and Florida to Brazil, including Caribbean Sea.',
        description: 'Large fish with a robust body. Light brown with darker bars and stripes. Can change color dramatically.',
        status: Status.DRAFT,
